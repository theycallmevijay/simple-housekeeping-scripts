#######################################################################################
#      Debian: Download latest Emacs source code | Compile the source code
#              into binary | Install compile Emacs binary  
#######################################################################################
...
# Download and install the build essentials   
sudo apt update
sudo apt install -y autoconf make gcc texinfo libgtk-3-dev libxpm-dev \
     libjpeg-dev libgif-dev libtiff5-dev libgnutls28-dev libncurses5-dev \
     libjansson-dev libharfbuzz-dev libharfbuzz-bin imagemagick \
     libmagickwand-dev libgccjit-10-dev libgccjit0 gcc-10 libjansson4 \
     libjansson-dev xaw3dg-dev texinfo libx11-dev
